...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="action_create_user.php" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="simpleinput" class="form-control" name="telephone_number">
                                </div>
                        ...
                        <div class="panel-container">
                            ...
                            <?php if(!empty($_SESSION["error"])):?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="example-fileinput" class="form-control-file" name="user_image">
                                </div>
                            </div>
                        </div>
