                                ...
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <span class="status status-<?php echo $status;?> mr-3">
                                            <?php if(empty($user["user_image"])):?>
                                                <span class="rounded-circle profile-image d-block " style="background-image:url('uploads/avatar-m.png'); background-size: cover;"></span>
                                            <?php else:?>
                                                <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user["user_image"];?>'); background-size: cover;"></span>
                                                
                                            <?php endif;?>
                                    </span>
                                    <div class="info-card-text flex-1">
                                        <?php if(checkAccess($user["id"])):?>
                                        ...
                                        <?php endif;?>
                                        <span class="text-truncate text-truncate-xl"><?php echo $user["title"];?></span>
                                    </div>
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3">
                                    <?php if(empty($user["telephone_number"])):?>
                                        <a href="tel:+xxxxxxxxxx" class="mt-1 d-block fs-sm fw-400 text-dark">
                                        <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo "x (xxx) xx xx xxx";?></a>
                                    <?php else:?>
                                        <a href="tel:<?php echo str_replace([" ", "-"], "", $user["telephone_number"]);?>" class="mt-1 d-block fs-sm fw-400 text-dark">
